 ...
 */
public class ${CLASSNAME} extends ${CLASS:emxPLCCommonBase} {
    ...
    public int mxMain (Context context, String[] args) throws Exception {
        if (!context.isConnected()) {
            String sContentLabel = i18nNow.getI18nString(ERROR_UNSUPPORTEDCLIENT,
                                       "emxProductLineStringResource", context.getSession().getLanguage());
